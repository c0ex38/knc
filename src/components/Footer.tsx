                ...
                <div style={containerStyle} className="footer__container">
                    ...
                    <div style={leftStyle}>
                        ...
                        <div style={contactStyle}>
                            <a 
                                ...
                                style={{ ...infoStyle, color: 'inherit', textDecoration: 'none' }}
                            ...
                            <a 
                                ...
                                style={{ ...addressStyle, color: 'inherit', textDecoration: 'none' }}
                                className="footer__contact-link"
                            >
                                {contactInfo.address}
                            </a>
                    ...
                    <div style={rightStyle} className="footer__right">
                        <nav style={navStyle}>
                            ...
                            <a href="https://www.flasreklam.com" target="_blank" rel="noopener noreferrer" style={navLinkStyle} className="footer__nav-link">flaş reklam</a>
                        </nav>
                        ...
                        <div style={socialsStyle}>
                            ...
                            <a href="https://www.instagram.com/knccreative_/" target="_blank" rel="noopener noreferrer" style={socialLinkStyle} className="footer__social-link" aria-label="X">
                            ...
                            <a href="https://www.instagram.com/knccreative_/" target="_blank" rel="noopener noreferrer" style={socialLinkStyle} className="footer__social-link" aria-label="Facebook">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
                            </a>
                            <a href="https://www.instagram.com/knccreative_/" target="_blank" rel="noopener noreferrer" style={socialLinkStyle} className="footer__social-link" aria-label="Spotify">
